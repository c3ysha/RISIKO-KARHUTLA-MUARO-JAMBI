...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [261865.669870, 9759498.266903, 435882.425504, 9871835.750262], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32748',
...
map.getView().fit([261865.669870, 9759498.266903, 435882.425504, 9871835.750262], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">RISIKO KEBAKARAN HUTAN DAN LAHAN KABUPATEN MUARO JAMBI</h2>';
        return titleElement;
    })(),
